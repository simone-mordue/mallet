...
```{r}
library(dplyr)
load("~/OneDrive - Newcastle University/RMallet/mallet/data/sotu.rda")
data(sotu)
sotu[["text"]][1:2]
```
...
stopwords_en <- system.file("/project_sim/mallet/stoplists/en.txt", package = "mallet")
```
...
sotu.instances <- 
  mallet.import(id.array = row.names(sotu), 
                ...
                stoplist = "mallet/inst/stoplists/en.txt",
